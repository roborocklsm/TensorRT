 ...
 */
#ifndef TRT_CUSTOM_NMS_PLUGIN_H
#define TRT_CUSTOM_NMS_PLUGIN_H
...
class CustomNMSPlugin : public IPluginV2DynamicExt
{
public:
    CustomNMSPlugin(CustomNMSParameters param);

    CustomNMSPlugin(const void* data, size_t length);

    ~CustomNMSPlugin() override = default;
...
class CustomNMSPluginCreator : public BaseCreator
{
public:
    CustomNMSPluginCreator();

    ~CustomNMSPluginCreator() override = default;
